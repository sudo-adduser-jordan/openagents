...
func validateManifest(m manifest) error {
	...
	if len(m.Providers) != 2 {
		return errors.New("manifest must contain exactly two providers")
	}
	for index, providerID := range []string{"openai", "zai"} {
