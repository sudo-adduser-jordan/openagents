...
// Deliver but intentionally bypasses input admission. It is only for an Open Agents
...
// CoordinationUnderMutation writes an Open Agents coordination message while the caller
...
// Nudge writes an Open Agents-initiated (unsolicited) message into a live agent. Its
...
// NudgeUrgent writes an Open Agents-initiated message that must reach the agent even
...
// NudgeCoordination writes an Open Agents-initiated coordination message under the full
