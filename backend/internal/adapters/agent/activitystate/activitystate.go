// Package activitystate holds the standard mapping from an Open Agents hook sub-command
...
// StandardDeriveActivityState maps a hook sub-command name onto an Open Agents activity
