---
title: Notifications
description: Durable in-app notifications and Electron toasts built into Open Agents.
---

Notifications are a daemon and desktop capability, not a configurable plugin slot. Open Agents currently persists notifications for these lifecycle events:
