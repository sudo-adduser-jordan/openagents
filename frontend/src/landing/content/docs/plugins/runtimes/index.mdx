---
title: Runtime
description: Open Agents automatically uses tmux on macOS/Linux and ConPTY on Windows.
---
...
Run `open-agents doctor` to check the runtime required on the current platform.
