...
This is built into the desktop app. There is no `terminal: web` setting, `open-agents open` command, or iTerm2/AppleScript terminal plugin in the current release.
