...
Configure reviewers in project settings. Codex and OpenCode are supported reviewer harnesses. If the project has no reviewer configured, AO reuses a review-capable worker harness or falls back to Codex.
