...
For compatible Codex and OpenCode sessions, use **Open Chat** or **Open Terminal UI**. AO preserves the session and worktree, drains or interrupts active work according to your choice, and commits only one controller at a time.
