...
export function OrganizationJsonLd() {
	...
	const schema = {
		...
		logo: `${COMPANY.MARKETING_URL}/open-agents-logo.svg`,
		...
		sameAs: [COMPANY.GITHUB_URL, COMPANY.X_URL, COMPANY.LINKEDIN_URL].filter(
...
export function ArticleJsonLd({
	...
	const schema = {
		...
		publisher: {
			...
			logo: {
				"@type": "ImageObject",
				url: `${COMPANY.MARKETING_URL}/open-agents-logo.svg`,
			},
		},
