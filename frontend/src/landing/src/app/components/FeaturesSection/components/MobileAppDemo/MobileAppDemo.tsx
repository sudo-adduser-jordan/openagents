...
type ProjectId = "all" | "open-agents-mo" | "meetyou" | "adorable";
...
const sessions: Session[] = [
  {
    id: 16,
    project: "open-agents-mo",
    projectLabel: "agent-orch…trator-mo",
    title: "auth migration",
    branch: "open-agents/open-agents-mo-16/root",
    zone: "action",
    status: "Needs input",
    statusColor: t.amber,
    time: "4m",
  ...
  },
  {
    ...
    projectLabel: "agent-orch…trator-mo",
    title: "mobile revamp",
    branch: "open-agents/open-agents-mo-17/root",
    zone: "working",
    status: "Working",
  ...
  },
  {
    ...
    projectLabel: "agent-orch…trator-mo",
    title: "onboarding",
    branch: "open-agents/open-agents-mo-18/root",
    zone: "working",
    status: "No signal",
  ...
  },
  {
    ...
    branch: "open-agents/meetyou-9/root",
    zone: "working",
    status: "Working",
    statusColor: t.orange,
    breathing: true,
  ...
  },
  {
    ...
    projectLabel: "meetyou",
    title: "fix-pin-unpin",
    branch: "open-agents/meetyou-6/pin-fix-and-restore",
    zone: "merge",
    status: "Merged",
    statusColor: t.green,
    time: "6h",
  ...
  },
  {
    ...
    branch: "open-agents/adorable-2/root",
    zone: "working",
    status: "Working",
    statusColor: t.orange,
    breathing: true,
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-[7px]">
          ...
          <span className="relative block size-[22px]">
            <img src="/open-agents-logo.svg" alt="" className="size-full" draggable="false" loading="lazy" decoding="async" />
            <span
...
const pullRequests: {
...
}[] = [
  {
    ...
    meta: "open-agents/precision-market-4/dictation → main · Prasad-D-Ware",
  ...
  },
  {
    ...
    meta: "open-agents/prediction-market-12/settle-tx → main · Prasad-D-…",
    files: 7,
    added: 322,
    removed: 39,
    status: "Merged",
  ...
  },
  {
    ...
    meta: "open-agents/prediction-market-11/docs-cleanup → main · Prasad…",
    files: 11,
    added: 72,
    removed: 141,
    status: "Merged",
