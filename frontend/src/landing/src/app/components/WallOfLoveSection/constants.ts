...
export const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    handle: "LinkedIn",
    content:
      "Open Agents helped me in removing the friction of using multiple harnesses at the same time. I can just work in peace without ever worrying about running grok, omp, or opencode CLI separately. I get the best of all worlds!",
  ...
  },
  {
    ...
    handle: "@buchireddy",
    content:
      "I really loved the building blocks present in @openagents, hence we went all-in on that pretty early. Happy to share more details if it helps others.",
