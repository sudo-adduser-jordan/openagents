...
export interface paths {
    ...
    "/api/v1/sessions/{sessionId}": {
        ...
        put?: never;
        post?: never;
        /** Permanently remove a terminated session and its record */
    ...
    "/api/v1/sessions/{sessionId}/conversation/clear-history": {
        ...
        get?: never;
        put?: never;
        /** Start a chat session's conversation over, so the agent stops carrying earlier tasks */
        post: operations["clearSessionConversationHistory"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/sessions/{sessionId}/conversation/turns/{turnId}/delete-before": {
        ...
        get?: never;
        put?: never;
        /** Permanently delete rendered manager history before a turn */
        post: operations["deleteSessionConversationHistoryBefore"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/settings/opencode-config": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Read the user's own opencode configuration for editing */
        get: operations["getOpencodeConfig"];
        /** Replace the user's own opencode configuration */
        put: operations["updateOpencodeConfig"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
...
export interface operations {
    ...
    clearSessionConversationHistory: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    deleteSessionConversationHistoryBefore: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DeleteHistoryBeforeResponse"];
                };
            };
            /** @description Forbidden */
            403: {
    ...
    getOpencodeConfig: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["OpencodeconfigDocument"];
                };
            };
            /** @description Internal Server Error */
            500: {
    ...
    updateOpencodeConfig: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["OpencodeconfigWriteRequest"];
            };
        };
        responses: {
            /** @description OK */
