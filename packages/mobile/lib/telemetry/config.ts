...
/**
 * Kill switches, mirroring the desktop's OPEN_AGENTS_TELEMETRY_DISABLED_EVENTS. Build-time
...
export const MOBILE_TELEMETRY_DISABLED =
	(process.env.EXPO_PUBLIC_OPEN_AGENTS_TELEMETRY_DISABLED ?? "").trim() === "1";

export const MOBILE_DISABLED_EVENTS = (process.env.EXPO_PUBLIC_OPEN_AGENTS_TELEMETRY_DISABLED_EVENTS ?? "")
	.split(",")
