...
- The primary listener remains unauthenticated loopback-only. Policy control routes live under `/internal/agent-switch-observability/*` and require the existing local-control guard.
