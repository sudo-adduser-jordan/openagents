...
- Shell out where Open Agents needs the user's real developer-machine behavior, especially
...
| HTTP API           | `net/http` + `github.com/go-chi/chi/v5`                                                         | Implemented            | Lightweight, idiomatic router without committing Open Agents to a large web framework.                                                       |
...
validate `github.com/ncruces/go-sqlite3/driver` against Open Agents's WAL, migration,
...
| Avoid                                                          | Reason                                                                                        |
| -------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| GORM                                                           | Open Agents needs explicit transactional SQL and CDC-triggered writes.                                 |
| Gin/Fiber                                                      | `net/http` + `chi` is enough for a local daemon API.                                          |
| `go-git` as the primary Git engine                             | Open Agents should match installed Git behavior, credentials, hooks, LFS, submodules, and user config. |
